        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .gg-field:nth-child(3) { animation-delay: 0.26s; }
                ...
                .gg-input:hover:not(:focus) {
                    border-color: rgba(90,138,106,0.45);
                }
                ...
                .gg-field.is-focused .gg-input-icon {
                    color: var(--moss);
                }
            ...
            <div className="gg-root">
                ...
                <div className="gg-right">
                    <div className="gg-card">
                        ...
                        <p className="gg-login-link" style={{ marginTop: 16 }}>
